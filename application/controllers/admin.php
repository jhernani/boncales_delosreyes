...
public function viewUpdateUserForm()
{
	...
	$this->load->view('includes/banner');
	$this->load->view('admin/admin-menu');
	$this->load->view('admin/update-user-form');
}
...
public function viewUserProfile()
{
	...
	$this->load->view('includes/banner');
	$this->load->view('admin/admin-menu');
	$this->load->view('admin/view-user-profile');
}
...
public function viewSubject()
{
	...
	$this->load->view('admin/admin-menu');
	$this->load->view('includes/sem_header');
	$this->load->view('admin/view-subject');
}
...
public function viewTeacherDashboard()
{
	...
	$this->load->view('includes/banner');
	$this->load->view('admin/admin-menu');
	$this->load->view('admin/teacher-dashboard');
	//$this->load->view('admin/admin-landing-page', $data);
}
...
public function callUserSuccess()
{
	$this->load->view('includes/header');
	$this->load->view('includes/banner');
	$this->load->view('admin/admin-menu');
	$this->load->view('modals/add-user-success');
}
